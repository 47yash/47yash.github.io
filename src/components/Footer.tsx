...
const Footer = () => {
  ...
  return (
    <FooterContainer>
      ...
      >
        © {currentYear} Yash Gangane. All Rights Reserved.
      </FooterText>
      ...
      >
        <a href="https://github.com/47yash" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
        ...
        <a href="https://www.linkedin.com/in/yash-gangane-656004194/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          <svg viewBox="0 0 24 24" fill="currentColor">
        ...
        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=yashgangane987@gmail.com" target="_blank" rel="noopener noreferrer" aria-label="Email">
